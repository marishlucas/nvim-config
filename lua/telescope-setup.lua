...
vim.keymap.set('n', '<C-a>', require('telescope.builtin').buffers, { desc = '[ ] Find existing buffers' })
...
vim.keymap.set('n', '<leader>S', ':LiveGrepGitRoot<cr>', { desc = '[S]earch by [G]rep on Git Root' })
